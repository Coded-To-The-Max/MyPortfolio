...
The four `public/images/*-cover.png` assets are original generated typography-only covers. Their titles are centered with safe margins for responsive cropping. Next Image serves optimized versions. No generated photos or logos are used.
