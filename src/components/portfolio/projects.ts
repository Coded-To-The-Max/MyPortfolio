export const projects = [
  {
    ...
    image: '/images/collegeguide-cover.png', source: '/images/collegeguide-cover.png',
  ...
  },
  {
    ...
    image: '/images/habitflow-cover.png', source: '/images/habitflow-cover.png',
  ...
  },
  {
    ...
    image: '/images/desgen-cover.png', source: '/images/desgen-cover.png',
  ...
  },
  {
    ...
    image: '/images/stock-screener-cover.png', source: '/images/stock-screener-cover.png', href: '#screener-details', code: null,
  },
];

export const gallery = projects.map(project => ({
  image: project.image, title: `${project.name}: typography study`, detail: project.category,
}));
